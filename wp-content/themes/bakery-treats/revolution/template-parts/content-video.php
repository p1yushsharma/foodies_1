		...
		<?php
			...
			if (!is_singular() && !empty($bakery_treats_embeds)) {
			    ...
			    foreach ($bakery_treats_embeds as $bakery_treats_embed) {
			        ...
			        if (strpos($bakery_treats_embed, 'video') !== false || strpos($bakery_treats_embed, 'youtube') !== false || strpos($bakery_treats_embed, 'vimeo') !== false || strpos($bakery_treats_embed, 'dailymotion') !== false || strpos($bakery_treats_embed, 'vine') !== false || strpos($bakery_treats_embed, 'wordPress.tv') !== false || strpos($bakery_treats_embed, 'hulu') !== false) {
			            ?>
