	...
	function fresh_bakery_cake_the_custom_logo() {
		if ( function_exists( 'the_custom_logo' ) ) {
			if( has_custom_logo() ){
				...
				echo "<a href='".esc_url( home_url() )."' rel='home'><img src='".esc_url(get_template_directory_uri())."/images/Logo.png' alt='" . esc_attr__("Fresh Bakery Cake logo", 'fresh-bakery-cake') . "'/></a>";
			}
		}
	}
endif;
